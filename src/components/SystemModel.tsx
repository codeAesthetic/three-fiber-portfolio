      ...
      >
        ...
        <div>
          ...
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            I translate designs & wire-frames into high quality <br /> user
            interface with <span className="text-[#915eff]">Javascript</span>{" "}
            and <span className="text-[#915eff]">ReactJS</span>.
          </p>
        </div>
      </div>
      <ComputersCanvas />
